...
## Contents
**List of Turkish given names ([names.csv](CNLI-TR_augmentation/turkish-name-scraper/files/)):** This .csv file contains XX Turkish proper names [scraped](CNLI-TR_augmentation/turkish-name-scraper/scrape/) from web[^1]. Gender and origin of each name is indicated in the corresponding column.
